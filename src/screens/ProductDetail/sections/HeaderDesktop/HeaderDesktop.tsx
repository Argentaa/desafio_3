...
export const HeaderDesktop = (): JSX.Element => {
  ...
  return (
    <header className="flex w-full items-center justify-between px-[130px] py-7 border-b border-neutral-color10">
      ...
      <div className="flex items-center gap-3.5">
        ...
        <div className="flex items-center gap-3 pl-4 pr-5 py-3 bg-neutral-color00 rounded-[46px] w-[280px]">
          ...
          <Input
            className="border-0 bg-transparent p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-neutral-color40 font-body-14px-medium"
            placeholder="SearchIcon something here!"
          />
        </div>

        {/* Join community button */}
        <Button className="h-11 px-7 py-2.5 bg-primary-colordark-blue hover:bg-primary-colordark-blue-80 rounded-[57px] font-body-16px-bold text-neutral-color00">
          Join the community
        </Button>
        ...
        <div className="flex items-center gap-1 py-2 px-2">
          ...
          <ChevronDownIcon className="w-6 h-6 text-primary-colordark-blue" />
        </div>
      </div>
    </header>
  );
