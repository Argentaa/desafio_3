...
export const HeroBanner = (): JSX.Element => {
  return (
    <section className="relative w-full h-[695px] rounded-b-[40px] overflow-hidden [background:linear-gradient(134deg,rgba(252,238,213,1)_6%,rgba(252,238,213,1)_75%,rgba(255,231,186,1)_100%)]">
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-6">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 relative">
              <img
                className="absolute w-[910px] h-[611px] top-[-84px] right-[-100px]"
