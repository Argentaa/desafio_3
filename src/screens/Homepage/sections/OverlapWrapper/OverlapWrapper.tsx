...
export const OverlapWrapper = (): JSX.Element => {
  return (
    <section className="relative w-full max-w-[1180px] h-[378px] mx-auto rounded-[20px] overflow-hidden bg-[#ffb774] rotate-180">
      <div className="relative w-[1815px] h-[1455px] top-[-717px] left-[-331px]">
        <div className="absolute w-[978px] h-[908px] top-[547px] left-[837px]">
          <Card className="absolute w-[782px] h-[635px] top-[136px] left-[98px] bg-[#fceed5] rounded-[99px] rotate-[25.23deg] border-none shadow-none" />
          ...
          <Button className="absolute w-[163px] top-[226px] left-[439px] bg-primary-colordark-blue rounded-[57px] rotate-180 pt-3.5 pb-2.5 px-7">
          ...
          <Button
            variant="outline"
            className="absolute flex gap-2 top-[226px] left-[258px] rounded-[57px] border-[1.5px] border-solid border-[#003459] rotate-180 pt-3.5 pb-2.5 px-7"
          >
            ...
            <img
              className="mt-[-4.00px] -rotate-180 relative w-6 h-6"
          ...
          <img
            className="absolute w-[42px] h-[38px] top-[436px] left-[306px] -rotate-180"
            alt="Fontisto paw"
            src="/fontisto-paw.svg"
          />
        </div>
        ...
        <div className="absolute w-[1067px] h-[1095px] top-0 left-0">
          ...
          <img
            className="absolute w-[584px] h-[378px] top-[717px] left-[331px] -rotate-180 object-cover"
            alt="Pet image"
            src="/pngegg--4--1.png"
          />
        </div>
