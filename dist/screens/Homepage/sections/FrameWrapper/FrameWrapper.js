...
const FrameWrapper = () => {
    return (<section className="w-full py-16 px-4 md:px-8 lg:px-32">
      <div className="flex justify-between items-center mb-8">
        ...
        <button_1.Button variant="outline" className="rounded-full border-[1.5px] border-primary-colordark-blue px-7 py-3 flex items-center gap-2">
          <span className="font-body-14px-medium text-primary-colordark-blue">
            View more
          </span>
          <lucide_react_1.ChevronRightIcon className="h-5 w-5"/>
        </button_1.Button>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {products.slice(0, 4).map((product) => (<card_1.Card key={product.id} className="rounded-xl shadow-[0px_4px_28px_-2px_#00000014] bg-neutral-color00 border-0">
                    ...
                    <div className="relative w-5 h-5 rotate-180">
                      <div className="relative w-[17px] h-5 left-px">
                        <div className="relative h-5">
                          <img className="absolute w-[15px] h-[11px] top-[9px] left-0.5" alt="Vector" src="/vector-3.svg"/>
                          <img className="absolute w-2 h-[11px] top-[9px] left-0.5" alt="Vector" src="/vector-10.svg"/>
                          <img className="absolute w-2.5 h-[7px] top-0 left-0.5" alt="Vector" src="/vector-6.svg"/>
                          <img className="absolute w-[7px] h-[7px] top-0 left-0.5" alt="Vector" src="/vector.svg"/>
                          <img className="absolute w-[17px] h-2.5 top-0.5 left-0" alt="Vector" src="/vector-1.svg"/>
                          <img className="absolute w-2.5 h-2 top-1 left-0" alt="Vector" src="/vector-2.svg"/>
                          <img className="absolute w-[5px] h-4 top-1 left-1.5" alt="Group" src={`/group-${product.id * 2 - 1}.png`}/>
                          <img className="absolute w-1 h-4 top-1 left-1.5" alt="Group" src={`/group-${product.id * 2}.png`}/>
                        </div>
                      </div>
                    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-5">
        {products.slice(4).map((product, index) => (<card_1.Card key={product.id} className="rounded-xl shadow-[0px_4px_28px_-2px_#00000014] bg-neutral-color00 border-0">
            <card_1.CardContent className="p-2">
              <div className="flex flex-col gap-2">
                <div className="relative w-full h-[264px] bg-white rounded-[10px] overflow-hidden">
                  <img className="w-full h-full object-cover" alt={product.title} src={product.image}/>
                    ...
                    <div className="relative w-5 h-5 rotate-180">
                      <div className="relative w-[17px] h-5 left-px">
                        <div className="relative h-5">
                          ...
                          <img className="absolute w-[17px] h-2.5 top-0.5 left-0" alt="Vector" src="/vector-1.svg"/>
                          <img className="absolute w-2.5 h-2 top-1 left-0" alt="Vector" src="/vector-2.svg"/>
                          <img className="absolute w-[5px] h-4 top-1 left-1.5" alt="Group" src={`/group-${(index + 5) * 2 - 1}.png`}/>
                          <img className="absolute w-1 h-4 top-1 left-1.5" alt="Group" src={`/group-${(index + 5) * 2}.png`}/>
                        </div>
                      </div>
                    </div>
