...
const Banner = () => {
    return (<card_1.Card className="relative w-full bg-[#003459] rounded-[20px] overflow-hidden h-[378px]">
      <div className="relative w-full h-full overflow-hidden">
        ...
        <div className="absolute w-[978px] h-[908px] right-[-100px] top-[-360px]">
          ...
          {/* Buttons */}
          <button_1.Button className="absolute top-[634px] left-[439px] bg-primary-colordark-blue rounded-[57px] h-auto pt-3.5 pb-2.5 px-7">
          ...
          <button_1.Button variant="outline" className="absolute top-[634px] left-[258px] rounded-[57px] border-[1.5px] border-solid border-[#003459] h-auto flex items-center gap-2 pt-3.5 pb-2.5 px-7">
            ...
            <img className="w-6 h-6" alt="Media play circle" src="/media---play-circle.svg"/>
          </button_1.Button>
        </div>
        ...
        <div className="absolute w-[1067px] h-[1067px] left-[-331px] top-[29px]">
          ...
          <img className="absolute w-[513px] h-[342px] top-[7px] left-[351px] object-cover" alt="Person kissing puppy" src="/horizontal-shot-adult-girl-jeans-overalls-kissing-cute-puppy-whi.png"/>
        </div>
      </div>
    </card_1.Card>);
};
